...
<script type="text/javascript">
    ...
    var columns = [[{
        ...
        formatter:function(value,row,index){
            if(value!=null){
                return "<img src='"+value+"' style='width:150px;height:150px;'/>";
            }else{
                return "";
            }
        }
    ...
    $("#editBtn").click(function () {
        //判断
        let rows = $("#list").datagrid("getSelections");
        if (rows.length!=1){
            $.messager.alert("提示","修改操作只能选择一条","warning");
            return
        }

        window.location.href="promotion_add.jsp?id="+rows[0].id;
    })
</script>
</body>
</html>