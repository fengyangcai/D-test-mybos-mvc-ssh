		...
		<script type="text/javascript">
			$(function(){
				...
				$("#orderNum").blur(function(){
					$.post("../../order/findByOrderNum",{orderNum:$("#orderNum").val()},function(data){
						//填充表单
				...
				$("#wayBillNum").blur(function(){
					$.post("../../wayBill/findByWayBillNum",{wayBillNum:$("#wayBillNum").val()},function(data){
						//填充表单
						$("#waybillForm").form("load",data);
					},"json");
				});
				...
				$("#saveBtn").click(function(){
					$.post("../../wayBill/saveWayBill",$("#waybillForm").serialize(),function(data){
						if(data.success){
